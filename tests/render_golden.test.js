...
// 等で確認したうえで行うこと)。
const GOLDEN_HASH = "44cb437b7990cc1a3c62506567639eca630c6594af622ea4e4d9ceb9d7655c8e";
...
test("プレースホルダーキャラ描画のゴールデンハッシュ(静止状態)", async () => {
  ...
  try {
    ...
    const hash = await page.evaluate(async () => {
      ...
      const digest = await crypto.subtle.digest("SHA-256", imageData.data.buffer);
